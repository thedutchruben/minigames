...
public class LanguageModule {
    private static List<String> languages = Arrays.asList(Language.DUTCH, Language.ENGLISH, Language.GERMAN, Language.FRENCH, Language.RUSSIAN, Language.SPANISH, Language.INDONESIAN, Language.JAVANESE, Language.SWEDISH, Language.EMOJI);
