...
public class ItemBuilder {
    ...
    public ItemBuilder(final Material itemType, short type) {
        item = new ItemStack(itemType, 1, type);
        itemM = item.getItemMeta();
    }
    ...
    public ItemBuilder lores(final Set<String> lores) {
    ...
    /**
     * Adds and UnsafeEnchantment to the  with a level int value of 1.
     *
     * @param enchantment the {@link Enchantment} to add to the ItemStack.
     * @return the current instance for chainable application.
     * @since 1.0
